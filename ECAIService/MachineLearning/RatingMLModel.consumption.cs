...
namespace ECAIService
{
    ...
    {
        /// <summary>
        /// model input class for RatingMLModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for RatingMLModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("RatingMLModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Current");
            if (labelColumn == null)
            {
                throw new Exception("Current column not found. Make sure the name searched for matches the name in the schema.");
            }
