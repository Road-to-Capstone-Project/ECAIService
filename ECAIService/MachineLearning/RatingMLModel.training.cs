// This file was auto-generated by ML.NET TFModel Builder.
using System;
using System.IO;
...
{
    public partial class RatingMLModel
    {
        public const string RetrainFilePath =  @"D:\Projects\CSharp\ECAIService\ECAIService\Resources\sessions.csv";
        ...
        /// </summary>
        /// <param name="mlContext">The common context for all ML.NET operations.</param>
        /// <param name="model">TFModel to save.</param>
        ...
        {
            // Encoders process configuration with pipeline data transformations
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Current",inputColumnName:@"Current",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Current", sentence1ColumnName: @"Previous"))      
